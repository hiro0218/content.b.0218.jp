                ...
                <tr>
                    ...
                    <td>
                        <select name="position" id="position">
                            <option value="<?php echo MKJ_POSITION_BEFORE_FIRST_HEADING; ?>"<?php if (
  MKJ_POSITION_BEFORE_FIRST_HEADING == $this->options['position']
) {
  echo ' selected="selected"';
} ?>><?php _e('Before first heading (default)', 'kiku'); ?></option>
                            <option value="<?php echo MKJ_POSITION_AFTER_FIRST_HEADING; ?>"<?php if (
  MKJ_POSITION_AFTER_FIRST_HEADING == $this->options['position']
) {
  echo ' selected="selected"';
} ?>><?php _e('After first heading', 'kiku'); ?></option>
                            <option value="<?php echo MKJ_POSITION_CONTENTS_TOP; ?>"<?php if (
  MKJ_POSITION_CONTENTS_TOP == $this->options['position']
) {
  echo ' selected="selected"';
} ?>><?php _e('Top', 'kiku'); ?></option>
                            <option value="<?php echo MKJ_POSITION_CONTENTS_BOTTOM; ?>"<?php if (
  MKJ_POSITION_CONTENTS_BOTTOM == $this->options['position']
) {
  echo ' selected="selected"';
} ?>><?php _e('Bottom', 'kiku'); ?></option>
                        </select>
                    </td>
                </tr>
                <tr>
